INTERFACE
  ...
  & PRDELP, PT, PU, PV, PXURO, PXQRO, PXTRO, PAPRS, PQL, PQI, PCOEFN, PCD, PCDN, PCDROV, PCHROV, PCEROV, PCPS, PCT, PDQSTS,  &
  & PEMIS, PFHPS, PHQ, PHTR, PHU, PHV, PLSM, PIVEG, PNEIJ, PQS, PQSATS, PTP, PTS, PVEG, PXDROV, PXHROV, PWS, PWSI, PDSE, PCFAS,  &
  & PCFAU, PCFBS, PCFBU, PCFBV, PCFBQ, PCOEFA, PALPHA1, PLVT, PQICE, PDIFWQ, PDIFWS, PSFU, PSFV, PSC_FEVI, PSC_FEVN, PSC_FCLL,  &
  & PSC_FCLN, PFCHSP, PFCLL, PFCLN, PFCS, PFEVI, PFEVL, PFEVN, PFEVV, PFTR, PLHS, PQSH, PFRTH, PGZ0F, PGZ0HF, YDSTACK)
