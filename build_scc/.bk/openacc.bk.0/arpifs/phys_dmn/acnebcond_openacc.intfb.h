INTERFACE
  SUBROUTINE ACNEBCOND_OPENACC (YDCST, YDRIP, YDML_PHY_MF, KIDIA, KFDIA, KLON, KTDIA, KLEV, LDREDPR, YDSTA, PAPHI, PAPHIF,  &
  & PAPRSF, PCP, PR, PDELP, PRH, PBLH, PQ, PQI, PQL, PQW, PT, PNCV, PGM, PTS, PQCS, PNEBCOND, PHCRICS, PRHOUT, PQSATS, PRMF,  &
  & PQCS0, PNEBS0, YDSTACK)
