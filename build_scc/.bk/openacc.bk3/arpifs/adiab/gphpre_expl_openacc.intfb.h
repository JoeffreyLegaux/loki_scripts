...
!$acc routine( GPHPRE_EXPL_OPENACC )
    ...
    REAL(KIND=JPRB), OPTIONAL, INTENT(OUT) :: PDELP(KPROMA, KFLEV), PLNPR(KPROMA, KFLEV), PRDELP(KPROMA, KFLEV),  &
    & PALPH(KPROMA, KFLEV)
    REAL(KIND=JPRB), OPTIONAL, INTENT(OUT) :: PRTGR(KPROMA, KFLEV), PRPRE(KPROMA, KFLEV), PRPP(KPROMA, KFLEV)
