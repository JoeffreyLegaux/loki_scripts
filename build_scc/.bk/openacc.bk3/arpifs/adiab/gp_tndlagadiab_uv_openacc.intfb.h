INTERFACE
  SUBROUTINE GP_TNDLAGADIAB_UV_OPENACC (LDRPLANE, YDGEOMETRY, YDEPHY, YDDYN, KST, KEND, PRCORI, PGNORDL, PGNORDM, PSGRTL,  &
  & PSGRTM, PU, PV, PTNDU, PTNDV, PTNDU_NOC, PTNDV_NOC, YDSTACK)
!$acc routine( GP_TNDLAGADIAB_UV_OPENACC )
    ...
    INTEGER(KIND=JPIM), INTENT(IN) :: KST, KEND
