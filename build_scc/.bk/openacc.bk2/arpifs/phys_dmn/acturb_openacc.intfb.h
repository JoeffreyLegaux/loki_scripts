INTERFACE
  SUBROUTINE ACTURB_OPENACC (YDCST, YDPHY, YDPHY0, KIDIA, KFDIA, KLON, KTDIAT, KTDIAN, KLEV, PAPHI, PAPHIF, PAPRS, PAPRSF, PR,  &
  & PT, PU, PV, PECT, PQV, LDCONV, PLSCPE, PLMECT, PPHI3, PCD, PCH, PGZ0, PTS, PQS, PQICE, PQLI, PKTROV, PKQROV, PKQLROV,  &
  & PKUROV, PNBVNO, PPRODTH, PNEBS, PQCS, PL3F2, PGKCLS, PECTCLS, YDSTACK)
!$acc routine( ACTURB_OPENACC )
