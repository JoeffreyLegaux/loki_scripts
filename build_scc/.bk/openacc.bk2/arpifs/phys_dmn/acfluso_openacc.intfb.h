INTERFACE
  SUBROUTINE ACFLUSO_OPENACC (YDCST, YDML_PHY_MF, KIDIA, KFDIA, KLON, KLEV, PAPHI, PAPHIF, PAPRS, PAPRSF, PQ, PT, PU, PV,  &
  & PDPHIT, PDPHIU, PGZ0, PLSM, PQSATS, PRTI, PTS, LDHMT, PCD, PCDN, PCDROV, PCE, PCEROV, PCH, PCHROV, PQCLS, PRHCLS, PTCLS,  &
  & PUCLS, PVCLS, PURAF, PVRAF, YDSTACK)
