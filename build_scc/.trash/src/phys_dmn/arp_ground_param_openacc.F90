...
PGZ0HF (JLON)=PGZ0HF (JLON)+ZMERL*(PGZ0F (JLON)*EXP (-SQRT (PCD (JLON)*SQRT&
& ((PCFBU (JLON, KLEV)**2+PCFBV (JLON, KLEV)**2)*(PU (JLON, KLEV)**2+PV&
& (JLON, KLEV)**2)))*YDML_PHY_MF%YRPHY0%VZIUSTAR0)-PGZ0HF (JLON))
...
ENDSUBROUTINE ARP_GROUND_PARAM_OPENACC
