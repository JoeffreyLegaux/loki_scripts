...
& PVERVEL, PQHFL, PAHFS, PAPHM1, PAP, PAPH, PGEO, PGEOH, PGAW, PCUCONVCA, PGP2DSPP, PTENT, PTENQ, PTENU, PTENV, PTENTA, PTENQA,  &
& PARPRC, KTOPC, KBASEC, KTYPE, KCBOT, KCTOP, KBOTSC, LDCUM, LDSC, KCBOT_LIG, KCTOP_LIG, LDCUM_LIG, LDSHCV, PLCRIT_AER, PLU,  &
& PLUDE, PLUDELI, PSNDE, PMFU, PMFD, PDIFCQ, PDIFCS, PFHPCL, PFHPCN, PFPLCL, PFPLCN, PLRAIN, PRSUD, PSTRCU, PSTRCV, PFCQLF,  &
& PFCQIF, PMFUDE_RATE, PMFDDE_RATE, PCAPE, PWMEAN, PVDISCU, PDISS, KTRAC, PCM1, PTENC, PSCAV, PSCAV0)
  ...
  REAL(KIND=JPRB) :: ZTP1(KLON, KLEV), ZQP1(KLON, KLEV), ZUP1(KLON, KLEV), ZVP1(KLON, KLEV), ZTU(KLON, KLEV), ZQU(KLON, KLEV),  &
  ...
  REAL(KIND=JPRB) :: ZQEA(KLON, KLEV), ZTEA(KLON, KLEV), ZVEA(KLON, KLEV), ZUEA(KLON, KLEV), ZENTHD(KLON, KLEV),  &
  & ZENTHS(KLON, KLEV)
...
#include "fcttrm.func.h"
  ...
  ASSOCIATE (NJKT2=>YDML_PHY_EC%YRECUMF%NJKT2, LPHYLIN=>YDML_PHY_SLIN%YREPHLI%LPHYLIN, RLPTRC=>YDML_PHY_SLIN%YREPHLI%RLPTRC,  &
  & LEPCLD=>YDML_PHY_EC%YREPHY%LEPCLD, LMFTRAC=>YDML_PHY_EC%YREPHY%LMFTRAC, RCPD=>YDCST%RCPD, RG=>YDCST%RG, RLSTT=>YDCST%RLSTT,  &
  & RLVTT=>YDCST%RLVTT, RVTMP2=>YDTHF%RVTMP2, LENCLD2=>YDML_PHY_SLIN%YRPHNC%LENCLD2)
  ...
  IFLAG = 1
  CALL SATUR(YDTHF, YDCST, KIDIA, KFDIA, KLON, NJKT2, KLEV, YDML_PHY_SLIN%YREPHLI%LPHYLIN, PAP, ZTP1, ZQSAT, IFLAG)
  ...
  LLTDKMF = .true.
  CALL CUMASTRN(PPLDARE, PPLRG, YDTHF, YDCST, YDML_PHY_SLIN, YDML_PHY_EC, YGFL, YDCHEM, YDSPP_CONFIG, KIDIA, KFDIA, KLON, KLEV,  &
  & PDX, LLTDKMF, LDMCAPEA, LDLAND, PTSPHY, ZTP1, ZQP1, ZUP1, ZVP1, PLITOT, PVERVEL, ZQSAT, PQHFL, PAHFS, PAP, PAPH, PGEO,  &
  & PGEOH, PGAW, PCUCONVCA, PGP2DSPP, PTENT, PTENQ, PTENU, PTENV, PTENTA, PTENQA, LDCUM, KTYPE, KCBOT, KCTOP, LDCUM_LIG,  &
  ...
  CALL CUCCDIA(YDERAD, YDML_PHY_SLIN%YREPHLI, YDML_PHY_EC%YREPHY, KIDIA, KFDIA, KLON, KLEV, KSTEP, KCBOT, KCTOP, LDCUM, ZQU,  &
  & PLU, PMFU, ZRAIN, PARPRC, KTOPC, KBASEC)
  ...
  DO JK=1,KLEV
    ...
    DO JL=KIDIA,KFDIA
      ...
      PDIFCS(JL, JK + 1) = PDIFCS(JL, JK + 1) - PFHPCL(JL, JK + 1) - PFHPCN(JL, JK + 1) + RLVTT*ZCONDFLL(JL) + RLSTT*ZCONDFLN(JL)
