...
#include "stack.h"
  ...
  REAL(KIND=JPRB), INTENT(IN) :: PAIPCMT
  ...
  ELSE
    ...
    ELSE IF (YDML_PHY_MF%YRPHY%LGPCMT .and. YDML_PHY_MF%YRPHY%LRNUMX) THEN
      DO JLEV=KTDIA,KLEV
        ...
        PNEB(JLON, JLEV) = PAIPCMT*PNEB(JLON, JLEV) + (1._JPRB - PAIPCMT)*ZNEB_NON_PCMT
        PNEBC(JLON, JLEV) = PAIPCMT*PNEBC(JLON, JLEV) + (1._JPRB - PAIPCMT)*ZNEBC_NON_PCMT
      END DO
