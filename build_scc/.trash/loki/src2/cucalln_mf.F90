...
#include "fcttrm.func.h"
  ...
  DO JK=1,KLEV
    ...
    PDIFCS(JL, JK + 1) =  &
    & PDIFCS(JL, JK + 1) - PFHPCL(JL, JK + 1) - PFHPCN(JL, JK + 1) + YDCST%RLVTT*ZCONDFLL + YDCST%RLSTT*ZCONDFLN
