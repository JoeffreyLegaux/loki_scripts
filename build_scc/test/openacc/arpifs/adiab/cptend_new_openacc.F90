...
& PFCQNG, PFRMH, PFRMQ, PFCHQ, PFRSO, PFRTH, PSTRCU, PSTRCV, PSTRDU, PSTRDV, PSTRTU, PSTRTV, PSTRMU, PSTRMV, PDIFCQLC, PDIFCQIC,  &
...
#include "fcttrm.func.h"
  ...
  DO JLEV=1,KFLEV
    ...
    & PDIFCQ(JLON, JLEV)) + (PFRMQ(JLON, JLEV - 1) - PFRMQ(JLON, JLEV)) + (PFCHQ(JLON, JLEV - 1) - PFCHQ(JLON, JLEV)) +  &
    & (PFCCQL(JLON, JLEV - 1) - PFCCQL(JLON, JLEV)) + (PFCCQN(JLON, JLEV - 1) - PFCCQN(JLON, JLEV)) + (PFCSQL(JLON, JLEV - 1) -  &
    & PFCSQL(JLON, JLEV)) + (PFCSQN(JLON, JLEV - 1) - PFCSQN(JLON, JLEV)) + (PFCQNG(JLON, JLEV - 1) - PFCQNG(JLON, JLEV)) -  &
    & (PFECL(JLON, JLEV - 1) - PFECL(JLON, JLEV)) - (PFESL(JLON, JLEV - 1) - PFESL(JLON, JLEV)) - (PFECN(JLON, JLEV - 1) -  &
    & PFECN(JLON, JLEV)) - (PFESN(JLON, JLEV - 1) - PFESN(JLON, JLEV)))
