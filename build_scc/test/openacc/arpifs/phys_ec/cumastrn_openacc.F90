SUBROUTINE CUMASTRN_OPENACC (PPLDARE, PPLRG, YDTHF, YDCST, YDML_PHY_SLIN, YDML_PHY_EC, YGFL, YDCHEM, YDSPP_CONFIG, YDPERTPAR,  &
...
& KCTOP, LDCUM_LIG, KCBOT_LIG, KCTOP_LIG, KBOTSC, LDSC, LDSHCV, PLCRIT_AER, PTU, PQU, PLU, PLUDE, PLUDELI, PSNDE, PENTH, PMFLXR,  &
& PMFLXS, PRAIN, PLRAIN, PRSUD, PMFU, PMFD, PLGLAC, PMFUDE_RATE, PMFDDE_RATE, PCAPE, PWU, PWMEAN, PVDISCU, PDISS, KTRAC, PCEN,  &
& PTENC, PSCAV, PSCAV0, YDSTACK)
...
#include "fcttre.func.h"
  ...
  & PLUDE, PLUDELI, ZDMFUP, PLCRIT_AER, ZDMFEN, KCBOT, KCTOP, ICTOP0, IDPL, PMFUDE_RATE, ZKINEU, PWU, PWMEAN, YDSTACK=YLSTACK)
  ...
  & PGEO, PTEN, ZTENH, PQEN, ZQENH, PQSEN, PLGLAC, PLUDE, PLUDELI, PSNDE, PMFU, PMFD, ZMFUS, ZMFDS, ZMFUQ, ZMFDQ, ZMFUL, ZDMFUP,  &
  ...
  IF (YDML_PHY_EC%YRECUMF%LMFDUDV) THEN
    ...
    CALL CUDUDV_OPENACC(YDCST, YDML_PHY_EC%YRECUMF, YDSPP_CONFIG, YDPERTPAR, KIDIA, KFDIA, KLON, KLEV, ITOPM2, KTYPE, KCBOT,  &
