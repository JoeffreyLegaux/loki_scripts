INTERFACE
  SUBROUTINE CUENTR_OPENACC (YDCST, YDECUMF, YDSPP_CONFIG, KIDIA, KFDIA, KLON, KLEV, KK, KCBOT, KTYPE, LDCUM, LDWORK, PQSEN,  &
  & PAPH, PGEOH, PMFU, PGP2DSPP, PDMFEN, PDMFDE, YDSTACK)
