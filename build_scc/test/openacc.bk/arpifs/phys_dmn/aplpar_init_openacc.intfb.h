INTERFACE
  SUBROUTINE APLPAR_INIT_OPENACC (LDAROME, KIDIA, KFDIA, KLON, KLEV, KSGST, KCSS, PVEG0, PFRMQ, PFRCHQ, PCPS, PLHS, PRS, PLH,  &
  & PLSCPE, PQSAT, PQW, PTW, PCD, PCDN, PCH, PCHN, PC1, PC2, PEMIS, PFEVI, PFTKE, PFTKEI, PFEFB1, PFEFB2, PFEFB3, PNEIJ, PVEG,  &
  & PQSATS, KCLPH, YDSTACK)
!$acc routine( APLPAR_INIT_OPENACC ) seq
    ...
    ! PFRCHQ     : FLUX CHIMIQUE D'EAU
    ! PFRCHQ     : HUMIDITY CHEMICAL FLUX
    ...
    ! PCHN       : COEFFICIENT NEUTRE D'ECHANGE EN SURFACE POUR T ET Q.
    ! PCHN       : EXCHANGE COEFF. AT SURFACE LEVEL FOR T AND Q IN NEUTRAL CONDITIONS.
    ...
    ! PLOADSNOW  : ACCRETED WET SNOW MASS (KG/M)
    ! PLOADICE   : ACCRETED ICE MASS (KG/M)
    ! PDIAMACCR  : DIAMETER OF ACCRETED PRECIPITATION (M)
    ! PPCPWSNOW  : PRECIPITATION AS WET SNOW (MM)
    ! PPCPICE    : PRECIPITATION AS FREEZING RAIN (MM)
    ...
    !                             PDIAGH
    !        2023-10-04: A. Alias, PFRCHQ added
    !     ----------------------------------------------------------------------------------
