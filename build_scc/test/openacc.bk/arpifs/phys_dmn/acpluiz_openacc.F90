SUBROUTINE ACPLUIZ_OPENACC (YDCST, YDML_PHY_MF, KIDIA, KFDIA, KLON, KTDIA, KLEV, PT, PQ, PQL, PQI, PQR, PQS, PDELP, PAPRSF, PCP,  &
& PR, PNEBS, PQCS, PNEB_CVPP, PQLI_CVPP, PQC_DET_PCMT, PTENDH, PTENDQ, LDADJCLD, PAPHI, PTS, PNEIJ, PLSM, PGM, YDSTA, PFCSQL,  &
& PFCSQN, PFPLSL, PFPLSN, PFPEVPL, PFPEVPN, PFPFPL, PFPFPN, PSEDIQL, PSEDIQN, YDSTACK)
  !-----------------------------------------------------------------------
  ! - INPUT -
  ! - OUTPUT -
...
#include "fctdoi.func.h"
  ...
  IF (LDADJCLD) THEN
    ...
    CALL ACNEBSM_OPENACC(YDCST, YDML_PHY_MF%YRPHY0, KIDIA, KFDIA, KLON, KTDIA, KLEV, ZT, ZQ, PQL, PQI, PAPHI, PAPRSF, PCP, PR,  &
    & PGM, YDSTA, PQCS, PNEBS, ZRHCRI, ZRMF, ZQSATS, YDSTACK=YLSTACK)
  ...
  CALL ACMICRO_OPENACC(YDCST, YDML_PHY_MF, KIDIA, KFDIA, KLON, KTDIA, KLEV, PNEBS, ZT, ZQL, ZQI, PTS, PNEIJ, PLSM, ZAUTOL,  &
  & ZAUTOI, YDSTACK=YLSTACK)
  ...
  CALL ADVPRCS_OPENACC(YDCST, YDML_PHY_MF, KIDIA, KFDIA, KLON, KTDIA, KLEV, ZT, ZQ, ZQL, ZQI, ZAUTOL, ZAUTOI, PQR, PQS, PNEBS,  &
  & PCP, PR, PAPHI, PAPRSF, PDELP, PFPLSL, PFPLSN, PFPEVPL, PFPEVPN, PFPFPL, PFPFPN, PSEDIQL, PSEDIQN, YDSTACK=YLSTACK)
